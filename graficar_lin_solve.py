...
archivo_asm128 = open('asm_128.csv', "r")
archivo_c128 = open('c_128.csv', "r")

archivo_asm256 = open('asm_256.csv', "r")
archivo_c256 = open('c_256.csv', "r")

archivo_asm512 = open('asm_512.csv', "r")
archivo_c512 = open('c_512.csv', "r")
...
plt.bar(x, medianas_128, align='center')
...
plt.bar(x, medianas_256, align='center')
plt.xticks(x, lenguajes)
...
plt.bar(x, medianas_512, align='center')
plt.xticks(x, lenguajes)
